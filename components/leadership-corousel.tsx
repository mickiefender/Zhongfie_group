...
const teamMembers: TeamMember[] = [
  ...
  
  {
    ...
    image: '/EXECUTIVE TEAM/Mr. Shola.png',
    bio: 'Adejoro Oluwashola is a a leading Member of the Governing and Advisory Board of Zhongfei Groupe. He has been working diligently and represented Zhongfei in China, Ghana, Hong Kong, and Nigeria since 2015. In 2019, Oluwashola was nominated by the Chairman, Nana Kyei Baffour to Travel to China for high level and classified meetings on government levels, the Board assigned him to lead the delegation to Guangdong Province. This responsibility led to the establishment of the Miropass Malls in Nigeria, Togo and Benin. Adejoro is also the Executive Director Operations of De-Miropass Investment Ltd.',
  },
